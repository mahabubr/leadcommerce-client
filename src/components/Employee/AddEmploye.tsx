...
const AddEmploye = () => {
    const {handleCheckboxChange,onFinish,fileList,form,isLoading,api,currentImage,checkedValues,contextHolder,setCurrentImage,setFileList,beforeFileUpload,onChangeFileHandle} = useAddEmploye();

    return (
        <>
            {contextHolder}
            <PCBreadcrumb title='Create Product' route={paths.employees}/>
